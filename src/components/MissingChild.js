//register report form of missing child
import React from "react";

class MissingChildPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      childName: "",
  ...
  handleSubmit = (e) => {
    e.preventDefault();
    // Handle form submission here, that is send data to server
...
export default MissingChildPage;